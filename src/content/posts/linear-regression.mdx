...
The form of linear regression is one-variable or _univariate_ linear regression, which means there's a single feature for each data point. In the example it's possible to take other factors into consideration like number of bedrooms, location, etc.
