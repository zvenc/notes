...
The form of linear regression is _one-variable_ or _univariate_ linear regression, which means there's a single feature for each data point. In the example it's possible to take other factors into consideration like number of bedrooms, location, etc. In the next post I will demonstrate how we can achieve the model above using Python.
