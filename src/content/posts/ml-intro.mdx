...
## Supervised Learning
---
This approach to machine learning involves giving the computer a number of examples to learn from in the form of input-output pairs. Basically an input, also called a _feature_ is mapped to an output, also called _target_, and the computer observes a list of these mappings and tries to predict what the output should be for an input that isn't a part of the original mappings.
